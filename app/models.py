...
# --- MSSQL model (IT Master DB - read only, reflected) ---
# We use raw SQL queries for the MSSQL staff table to avoid
# needing a separate DeclarativeBase bound to the MSSQL engine.
